                ...
                case 5:
                    {
                        ...
                        {
                            Session.SendWhisper("Vamos, pelo menos, dar um nome ao bot!");
                            return;
                        }
                        else if (DataString.Length >= 16)
                        {
                            Session.SendWhisper("Vamos, o bot não precisa de um nome tão longo!");
                            return;
                        }
                        ...
                        {
                            Session.SendWhisper("Sem HTML, por favor :<");
                            return;
                        }
