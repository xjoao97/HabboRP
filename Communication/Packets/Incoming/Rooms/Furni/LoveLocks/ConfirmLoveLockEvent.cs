    ...
    class ConfirmLoveLockEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (UserOne == null && UserTwo == null)
            {
                ...
                Session.SendNotification("Seu parceiro deixou o quarto ou cancelou o cadeado do amor.");
                return;
            }
            ...
            else if (UserOne == null)
            {
                ...
                UserTwo.GetClient().SendNotification("Seu parceiro deixou o quarto ou cancelou o cadeado do amor.");
                UserTwo.LLPartner = 0;
                Item.InteractingUser = 0;
                Item.InteractingUser2 = 0;
                return;
            ...
            else if (UserTwo == null)
            {
                ...
                UserOne.GetClient().SendNotification("Seu parceiro deixou o quarto ou cancelou o cadeado do amor.");
                UserOne.LLPartner = 0;
                Item.InteractingUser = 0;
                Item.InteractingUser2 = 0;
                return;
            ...
            {
                UserTwo.CanWalk = true;
                UserTwo.GetClient().SendNotification("Parece que este cadeado de amor já foi bloqueado.");
                UserTwo.LLPartner = 0;

                UserOne.CanWalk = true;
                UserOne.GetClient().SendNotification("Parece que este cadeado de amor já foi bloqueado.");
                UserOne.LLPartner = 0;
