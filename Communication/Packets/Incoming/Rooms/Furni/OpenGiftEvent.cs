...
namespace Plus.Communication.Packets.Incoming.Rooms.Furni
{
    class OpenGiftEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (Data == null)
            {
                Session.SendNotification("Oops! Parece que houve um bug com este presente.\nNós vamos nos livrar disso.");
            ...
            {
                Session.SendNotification("Oops! Parece que houve um bug com este presente.\nNós vamos nos livrar disso para você.");
                Room.GetRoomItemHandler().RemoveFurniture(null, Present.Id, false);
            ...
            using (UserCache Purchaser = PlusEnvironment.GetGame().GetCacheManager().GenerateUser(PurchaserId))
            {
                if (Purchaser == null)
                {
                    Session.SendNotification("Oops! Parece que houve um bug com este presente.\nNós vamos nos livrar disso para você.");
            ...
            {
                Session.SendNotification("Opa, Parece que o item dentro do presente não está mais no hotel!");
                Room.GetRoomItemHandler().RemoveFurniture(null, Present.Id, false);
