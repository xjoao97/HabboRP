...
namespace Plus.HabboHotel.Permissions
{
    public sealed class PermissionManager
    {
        ...
        public void Init()
        {
            ...
            //log.Info("Carregado " + this.Permissions.Count + " permissões.");
            //log.Info("Carregado " + this.PermissionGroups.Count + " grupos de permissões.");
            //log.Info("Carregado " + this.PermissionGroupRights.Count + "direitos de grupo de permissões.");
            //log.Info("Carregado " + this.PermissionSubscriptionRights.Count + " direitos de subscrição de permissões.");
        }
