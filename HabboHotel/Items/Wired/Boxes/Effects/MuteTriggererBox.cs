...
namespace Plus.HabboHotel.Items.Wired.Boxes.Effects
{
    class MuteTriggererBox : IWiredItem
    {
        ...
        public bool Execute(params object[] Params)
        {
            ...
            {
                Player.GetClient().SendMessage(new WhisperComposer(User.VirtualId, "Exceção muda com fion: Player imutável", 0, 0));
                return false;
            }
            ...
            if (Time > 0)
            {
                Player.GetClient().SendMessage(new WhisperComposer(User.VirtualId, "Wired de Mutar: Mud por " + Time + "! Mensagem: " + Message, 0, 0));
