...
namespace Plus.HabboHotel.Catalog
{
    public class CatalogPage
    {
        ...
        public CatalogPage(int Id, int ParentId, bool Enabled, string Caption, string PageLink, int Icon, int MinRank, int MinVIP,
              bool Visible, string Template, string PageStrings1, string PageStrings2, Dictionary<int, CatalogItem> Items, Dictionary<int, CatalogDeal> Deals, ref Dictionary<int, int> flatOffers)
        {
            this._id = Id;
