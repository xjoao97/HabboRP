    ...
    public class InventoryComponent
    {
        ...
        public void Init()
        {
            ...
            foreach (Pet Pet in Pets)
            {
                ...
                {
                    Console.WriteLine("Erro ao carregar o animal de estimação: " + Pet.PetId);
                }
            }
            ...
            foreach (Bot Bot in Bots)
            {
                ...
                {
                    Console.WriteLine("Erro ao carregar o bot: " + Bot.Id);
                }
            }
        }
        ...
        public void ClearItems()
        {
            ...
            {
                dbClient.RunQuery("DELETE FROM `items` WHERE `room_id` = '0' AND `user_id` = '" + _userId + "' AND (`base_item` < '350000' OR `base_item` > '351000')");
            }
        ...
        public bool TryAddItem(Item item)
        {
            ...
            {
                throw new InvalidOperationException("O item não corresponde a nenhum item de piso ou parede");
            }
        }
