    ...
    public class RoomModel
    {
        ...
        public static short parse(char input)
        {
            ...
            switch (input)
            {
                ...
                default:
                    throw new FormatException("A entrada não estava no formato correto: a entrada deve estar entre (0-k)");
            }
        }
        ...
        public static byte parseByte(char input)
        {
            switch (input)
            {
                ...
                case '9':
                    return 9;
                default:
                    throw new FormatException("A entrada não estava no formato correto: a entrada deve estar entre 0 and 9");
            }
        }
