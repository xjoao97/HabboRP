...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Developers
{
    class KickBotsCommand : IChatCommand
    {
        ...
        {
            get { return "Expulsa todos os bots da sala."; }
        }
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            Session.Shout("*Expulsa imediatamente todos os bots da sala*", 23);
            Session.SendWhisper("Sucesso, expulsou todos os bots.", 1);
        }
    }
}
