...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Users.Jobs.General
{
    class PromoteCommand : IChatCommand
    {
        ...
        {
            get { return "Promove um dos trabalhadores da sua empresa."; }
        }
        ...
        public void Execute(GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (!Session.GetHabbo().GetPermissions().HasRight("corporation_rights"))
            {
                ...
                {
                    Session.SendWhisper("Você não pode promover o trabalhador ao mesmo cargo que você!", 1);
                    return;
                }
            ...
            {
                Session.SendWhisper("Você não pode mais promover o seu trabalhador!", 1);
                return;
            }
            #endregion
            ...
            Session.Shout("*Promove " + TargetClient.GetHabbo().Username + " na empresa " + Job.Name + " para o cargo " + Rank.Name + "*", Bubble);
            #endregion
        }
    }
}