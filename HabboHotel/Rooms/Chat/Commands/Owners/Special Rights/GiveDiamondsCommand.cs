    ...
    class GiveDiamondsCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            else if (Params[2] == "limpar" || Params[2] == "remover" || Params[2] == "retirar")
            {
                ...
                TargetClient.SendWhisper("Todos seus diamantes foram retirados por " + Session.GetHabbo().Username + ".", 1);
                Session.SendWhisper("Você acabou de remover todos os diamantes de " + TargetClient.GetHabbo().Username + ".", 1);
            }
            else
