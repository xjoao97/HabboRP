    ...
    class GiveCoinsCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            else if (Params[2] == "limpar" || Params[2] == "remover" || Params[2] == "retirar")
            {
                ...
                TargetClient.SendWhisper("Toda sua grana foi retirada por " + Session.GetHabbo().Username + ".", 1);
                Session.SendWhisper("Você acabou de remover todo dinheiro de " + TargetClient.GetHabbo().Username + ".", 1);
            }
            else
